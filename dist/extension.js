...
function activate(context) {
  const reportIssueCommand = vscode2.commands.registerCommand(
    "ps-replace-accents.reportIssue",
    async () => vscode2.env.openExternal(vscode2.Uri.parse("https://github.com/playfulsparkle/vscode_ps_replace_accents/issues"))
  );
